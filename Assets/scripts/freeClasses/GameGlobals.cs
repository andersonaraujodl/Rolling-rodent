...
public class GameGlobals  {
	...
	static public PlayersData[] playersToLoad = new PlayersData[]{
		new PlayersData(GameGlobals.atrib.PLAYER_ONE, new Vector4(1f,0f,0f,1f), 2.0f, 1.0f, 10f, 0.5f, "bola3", "roedorPath", "power"),
		...
		new PlayersData(GameGlobals.atrib.NPC, new Vector4(1f,0f,1f,1f), 4.0f, 3.0f, 50f, 0.8f, "bola3", "roedorPath", "power"),
